...
import { Container, Logo, Background, ButtonLink, Feature, Text, FeatureCallOut, Link, Group, Picture, Profile, SearchInput, Dropdown, Search, SearchIcon, PlayButton } from './styles/header';
